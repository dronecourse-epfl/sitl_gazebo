...
#define MAVLINK_MSG_ID_TARGET_POSITION_NED_LEN 13
#define MAVLINK_MSG_ID_TARGET_POSITION_NED_MIN_LEN 13
#define MAVLINK_MSG_ID_150_LEN 13
#define MAVLINK_MSG_ID_150_MIN_LEN 13

#define MAVLINK_MSG_ID_TARGET_POSITION_NED_CRC 136
#define MAVLINK_MSG_ID_150_CRC 136
...
#define MAVLINK_MESSAGE_INFO_TARGET_POSITION_NED { \
    ...
    {  { "x", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_target_position_ned_t, x) }, \
         ...
         { "target_num", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_target_position_ned_t, target_num) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TARGET_POSITION_NED { \
...
static inline uint16_t mavlink_msg_target_position_ned_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float x, float y, float z, uint8_t target_num)
{
...
{
    return mavlink_msg_target_position_ned_pack(system_id, component_id, msg, target_position_ned->x, target_position_ned->y, target_position_ned->z, target_position_ned->target_num);
}
...
{
    return mavlink_msg_target_position_ned_pack_chan(system_id, component_id, chan, msg, target_position_ned->x, target_position_ned->y, target_position_ned->z, target_position_ned->target_num);
}
...
static inline void mavlink_msg_target_position_ned_send(mavlink_channel_t chan, float x, float y, float z, uint8_t target_num)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_TARGET_POSITION_NED_LEN];
    _mav_put_float(buf, 0, x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_target_position_ned_send(chan, target_position_ned->x, target_position_ned->y, target_position_ned->z, target_position_ned->target_num);
#else
 ...
 */
static inline void mavlink_msg_target_position_ned_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float x, float y, float z, uint8_t target_num)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
